...
struct ImColor
{
    ...
    ImColor(int rgb, float alpha) : Value(static_cast<float>(rgb / 255.f), static_cast<float>(rgb / 255.f), static_cast<float>(rgb / 255.f), alpha) {}
    ImColor(int r, int g, int b, float alpha) : Value(static_cast<float>(r / 255.f), static_cast<float>(g / 255.f), static_cast<float>(b / 255.f), alpha) {}
